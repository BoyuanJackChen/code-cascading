            ...
            for question in all_questions_dict:
                ...
                for line in canonical_solution_lines:
                    if "=" in line and "input()" in line:
                        input_line = line
                        break
                input_line.replace("input()", "input_string")
                ...
                canonical_tests = question[test_key]
                canonical_tests_data = json.loads(canonical_tests)
                ...
                if pass_at == 0:
                    ...
                    prompt_testcode = original_prompt + def_line + checking_end
                    ...
                    max_new_tokens = min(2048-len(prompt_ids[0]), 10+50*args.test_lines)
                    with torch.no_grad():
