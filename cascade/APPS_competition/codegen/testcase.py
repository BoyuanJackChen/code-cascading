...
def process_prompt(prompt):
    result = f"""Write {FLAGS.assert_num} lines of code to test the correctness of solution:
{prompt}
...
def main(args):
    ...
    class StopSequences(LogitsProcessor):
        def __init__(self, stop_sequences, batch_size, encounters=5, eos_token_id=50256):
    ...
    for loop in range(num_loops):
        ...
        for question in all_questions_dict:
            ...
            if number<3000 or number>=4000 or number <= max_seen_number:
                continue
